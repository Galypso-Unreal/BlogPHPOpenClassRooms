...
class CommentRepository
{
    ...
    */
     ...
     * ID, and post ID.
     * @param string comment The parameter "$comment" is a string that represents the comment that will be added to the database.
     */
     ...
     * @param int identifier The parameter "$identifier" is an integer that represents the unique identifier of the comment that needs to be deleted.
     */
     ...
     * @param int identifier The parameter "$identifier" is an integer that represents the ID of the comment that needs to be validated.
     */
     ...
     * @param int identifier The parameter "$identifier" is an integer that represents the ID of a post. This function retrieves all the comments associated with that post from the database.
     * 
     * @return array an array of Comment objects.
     */
